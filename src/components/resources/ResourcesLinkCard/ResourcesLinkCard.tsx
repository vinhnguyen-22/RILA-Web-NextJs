...
export const ResourcesLinkCard: FC<ResourcesLinkCardProps> = ({ title, uri, type, tags }) => {
  const ResourceTypeIcon: FC<SVGProps<SVGSVGElement>> = RESOURCE_ICONS[type.name];

  return (
    <Link href={uri} target="_blank" className="flex flex-row w-full p-2 my-1 shadow hover:scale-[1.01] transition-all">
