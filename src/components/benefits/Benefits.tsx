      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="relative md:pr-[70px]">
            <h3 className="font-semibold md:text-3xl text-2xl leading-[50px] inline-block w-max-[561.16px]">
              ...
              {benefitsItems.map((item, index) => (
                <div key={index} className="flex items-start justify-center gap-[27px] ">
                  ...
                  <div className="flex flex-col items-start justify-start gap-[15px] ">
                    <div className="relative md:text-xl text-lg leading-[38px] font-semibold inline-block">{item.title} </div>
                    <div className="relative md:text-lg text-sm leading-[28px] text-black inline-block">{item.content}</div>
                  </div>
                </div>
              ))}
            </div>
