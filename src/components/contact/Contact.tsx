        ...
        <section className="mb-32">
          <div className="grid grid-cols-12">
            <div className="col-span-8">
              <div className="h-[313px] flex flex-col items-start justify-start">
                <Image
                  width={667}
                  height={0.5}
                  className="relative w-[667px] h-0.5"
                  alt=""
                  src="/images/homepage/vector-6.svg"
                />

                <div className="w-[616px] flex flex-row items-center justify-start">
                  <div className="w-[691px] flex flex-row py-8 px-2.5 box-border items-center justify-start">
                ...
                <div className="w-[713px] flex flex-row items-center justify-start">
                  <div className="flex-1 flex flex-row py-8 px-2.5 items-center justify-start">
                    <div className="relative leading-[36px]">How fast can RILA deliver a social listening report?</div>
                  </div>
                  <Image
                    className="relative w-6 h-6 overflow-hidden shrink-0"
                    width={6}
            ...
            <div className="col-span-4">
              <div className="mb-12  shrink-0 grow-0 basis-auto md:mb-0 md:w-7/12 md:px-3 lg:px-6">
                <div className="w-full shrink-0 grow-0 basis-auto md:w-5/12 md:px-3 lg:px-6">
                  <div className="flex flex-col items-start justify-start gap-[42px] text-21xl">
                    <div className="flex flex-col items-start justify-start gap-[32px]">
                      <div className="flex flex-col items-start justify-start gap-[16px]">
                        <div className="relative text-black tracking-[0.2px] leading-[52px] capitalize inline-block w-[487px]">
                          How can We help you?
                        </div>
                        <div className="relative text-xl leading-[36px] text-gray-500 inline-block w-[431px] opacity-[0.75] mix-blend-normal">
                      ...
                      <div className="flex flex-row items-start justify-start gap-[8px] text-base text-darkgray">
                        <div className="rounded-18xl bg-gray-100 flex flex-row py-5 px-[18px] box-border items-center justify-start">
                          <div className="relative capitalize">Enter your Email</div>
                        </div>
