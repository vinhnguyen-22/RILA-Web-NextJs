...
type CaseStudyDetailProps = CaseStudy | any;
const CaseStudyDetail: FC<CaseStudyDetailProps> = ({ CaseStudy }) => {
  return (
    <section className="">
      <div
        className="min-h-[460px] flex justify-center items-center bg-cover"
        style={{ backgroundImage: `url('${CaseStudy.cover}')` }}
      >
        <h1 className="text-23xl text-white text-center">{CaseStudy.title}</h1>
      </div>
          ...
          <div className="grid md:grid-cols-2 grid-cols-1">
            <div className="relative flex flex-col mb-[36px] gap-[15px] text-white ">
              <h3 className="capitalize font-semibold text-23xl">
                Get the full <span className="text-red-100">CaseStudy</span>
              </h3>
              ...
              <p className="text-base leading-7 before:content-[' '] before:h-[1px] after:">
                ...
                COVID-19, is neobanking. Using cutting edge data technology, in this CaseStudy we explore:
              </p>
