...
const ContactPage = () => {
  ...
  return (
    <div className="mx-auto md:mt-[50px] mt-[120px]">
      ...
      <div
        className="relative grid lg:grid-cols-2 grid-cols-1 mt-[135px] min-h-[649px] bg-cover bg-no-repeat"
        style={{ backgroundImage: `url('./images/about-us/rectangle-26.png')` }}
      >
        <div className="flex flex-col justify-center lg:items-end items-center md:mt-0 mt-[175px]">
      ...
      <div className="container mx-auto mt-[50px] mb-[100px]">
        <div className="grid grid-cols-12 lg:gap-[50px] max-lg:gap-[14px]">
          <div className="col-span-5 max-lg:col-span-12 max-lg:flex max-lg:flex-row max-lg:gap-[50px]">
            <h3 className="block relative text-black text-[50px]  max-md:text-[30px] font-bold leading-tight tracking-wider">
              ...
              Asked Questions{' '}
              <span className="absolute max-md:-right-[25px] xl:right-[90px] right-[10px]  max-lg:-right-[30px] max-md:bottom-[88px] -bottom-[18px] max-md:text-[60px] text-[100px] text-red-100">
                ?
              </span>
            </h3>
