...
export const isJournalEntry = (obj: { [key: string]: NotionDatabaseProperty }): obj is JournalEntry => {
  return (
    typeof obj === 'object' &&
    typeof obj.id === 'string' &&
    typeof obj.slug === 'string' &&
...
export const isLearningResource = (obj: { [key: string]: NotionDatabaseProperty }): obj is LearningResource => {
  return (
    typeof obj === 'object' &&
    typeof obj.id === 'string' &&
